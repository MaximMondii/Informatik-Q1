...
public class List<ContentType> {
    ...
    private ListNode getPrevious(ListNode pNode) {
        if (pNode == null || isEmpty() || pNode == first || findListNode(pNode)==null){
            ...
            //suche den Knoten und geben den Vorgänger zurück
    ...
    gibt null zurück, wenn der Knoten nicht in der Liste ist
    ansonsten wird der gesuchte Listenknoten zurückgegeben
